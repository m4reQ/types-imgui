...
# Condition enum
Condition = _t.NewType('Condition', int)
...
StyleVar = _t.NewType('StyleVar', int)
...
ButtonFlags = _t.NewType('ButtonFlags', int)
...
WindowFlags = _t.NewType('WindowFlags', int)
...
ColorEditFlags = _t.NewType('ColorEditFlags', int)
...
TreeNodeFlags = _t.NewType('TreeNodeFlags', int)
...
PopupFlags = _t.NewType('PopupFlags', int)
...
SelectableFlags = _t.NewType('SelectableFlags', int)
...
ComboFlags = _t.NewType('ComboFlags', int)
...
TabBarFlags = _t.NewType('TabBarFlags', int)
...
TabItemFlags = _t.NewType('TabItemFlags', int)
...
TableFlags = _t.NewType('TableFlags', int)
...
TableColumnFlags = _t.NewType('TableColumnFlags', int)
...
TableRowFlags = _t.NewType('TableRowFlags', int)
...
FocusFlags = _t.NewType('FocusFlags', int)
...
HoverFlags = _t.NewType('HoverFlags', int)
...
DragDropFlags = _t.NewType('DragDropFlags', int)
...
DragDropAcceptFlags = _t.NewType('DragDropAcceptFlags', int)
...
TextInputFlags = _t.NewType('TextInputFlags', int)
...
DrawCornerFlags = _t.NewType('DrawCornerFlags', int)
...
DrawFlags = _t.NewType('DrawFlags', int)
...
DrawListFlags = _t.NewType('DrawListFlags', int)
...
FontAtlasFlags = _t.NewType('FontAtlasFlags', int)
...
ConfigFlags = _t.NewType('ConfigFlags', int)
...
BackendFlags = _t.NewType('BackendFlags', int)
...
SliderFlags = _t.NewType('SliderFlags', int)
...
ViewportFlags = _t.NewType('ViewportFlags', int)
